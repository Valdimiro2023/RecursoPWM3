            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        <h2 class="pull-left">Detalhes do funcionario</h2>
                        <a href="create.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i>Adiciona funcionario</a>
                    </div>
                    <?php
                    // Include config file
                    ...
                    if($result = mysqli_query($link, $sql)){
                        if(mysqli_num_rows($result) > 0){
                            ...
                            echo '<div class="alert alert-danger"><em>nenhum registo</em></div>';
                        }
                    } else{
                        echo "Oops! erro.";
                    }
